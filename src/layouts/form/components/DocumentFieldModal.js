...
export default function DocumentFieldModal(props) {
    ...
    return (
        <>
            <NormalModal 
                ...
                cancelAction={props.closeFieldsModal} title={(editIndex !== null && props.openState) ? 'Modifier un champs de type Fichier' : 'Ajout d\'un champs de type Fichier'}
            >
