...
export default function UrlFieldModal(props) {
    ...
    return (
        <>
            <NormalModal 
                ...
                cancelAction={props.closeFieldsModal} title={(editIndex !== null && props.openState) ? 'Modifier un champs de type Url (lien)' : 'Ajout d\'un champs de type Url (lien)'}
            >
