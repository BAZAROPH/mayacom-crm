...
export default function DateFieldModal(props) {
    ...
    return (
        <>
            <NormalModal 
                ...
                cancelAction={props.closeFieldsModal} title={(editIndex !== null && props.openState) ? 'Modifier un champs de type date' : 'Ajout d\'un champs de type date'}
            >
