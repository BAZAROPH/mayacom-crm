...
export default function TextAreaFieldModal(props) {
    ...
    return (
        <>
                <NormalModal 
                    ...
                    cancelAction={props.closeFieldsModal} title={(editIndex !== null && props.openState) ? 'Modifier un champs de type zone de description' : 'Ajout d\'un champs de type zone de description'}
                >
