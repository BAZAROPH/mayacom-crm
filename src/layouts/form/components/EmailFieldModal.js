...
export default function EmailFieldModal(props) {
    ...
    return (
            <>
                <NormalModal 
                    ...
                    cancelAction={props.closeFieldsModal} title={(editIndex !== null && props.openState) ? 'Modifier un champs de type email' : 'Ajout d\'un champs de type email'}
                >
