...
export default function NumberFieldModal(props) {
    ...
    return (
        <>
            <NormalModal 
                ...
                cancelAction={props.closeFieldsModal} title={(editIndex !== null && props.openState) ? 'Modifier un champs de type nombre' : 'Ajout d\'un champs de type nombre'}
            >
